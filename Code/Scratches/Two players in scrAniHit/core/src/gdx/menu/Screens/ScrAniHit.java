...
public class ScrAniHit implements Screen, InputProcessor {
    ...
    Texture txSheet, txSheet2, txNamAH, txNamGame;
    Sprite sprNamAH, sprDude, sprAni, sprMouse, sprAni2;   //sprAni is a ghost, a sprite used for hit detection
    int nFrame, nPos, nX = 100, nY = 100;   //nX and nY coordinates for sprAni  hv
    Animation araniMouse[], araniMouse2[];
    int fW, fH, fSx, fSy, fSx2, fSy2;
    ...
    public void show() {
        ...
        for (int i = 0; i < 4; i++) {
            ...
            araniMouse2[i] = new Animation(0.8f, arSprMouse);

        }
        sprAni = new Sprite(txNamAH, 0, 0, fW, fH);
        sprAni.setPosition(200, 200);
        sprAni2 = new Sprite(txNamAH, 0, 0, fW, fH);
        sprAni2.setPosition(200, 200);
    ...
    public void render(float delta) {
        ...
        float fSx2 = sprAni2.getX();
        float fSy2 = sprAni2.getY();
        //Animation Stuff
        ...
        trTemp2 = araniMouse2[nPos].getKeyFrame(nFrame, false);
