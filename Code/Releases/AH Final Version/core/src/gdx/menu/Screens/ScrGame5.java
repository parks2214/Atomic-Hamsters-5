...
public class ScrGame5 implements Screen, InputProcessor {
    ...
    Texture txSheet1, txMap, txSheet2, txBar, txWall, txObstacle, txCornerHamster1, txCornerHamster2, txMHead, txMTail, txHamBar;
    ...
    int nHam2X1 = 300, nHam2Y1 = 300, nHam2X2 = 300, nHam2Y2 = 280, nHam2X3 = 300, nHam2Y3 = 260;
    int nHam2HeadX = 207, nHam2HeadY = 200, nHam2TailX = 220, nHam2TailY = 150;
    ...
    public void show() {
        ...
        pMaker2 = new PelletMaker("Moth ball.png");
    }
    ...
    public void render(float delta) {
        ...
        if (Gdx.input.isKeyPressed(Input.Keys.LEFT)) {
            ...
            for (int i = 0; i < arWall.length; i++) {
                if (!isHitS(arWall[i], sprMhead1test)) {
                    nHam1TailX = nHam1X3;
                    nHam1TailY = nHam1Y3;
                    nHam1X3 = nHam1X2;
                    nHam1Y3 = nHam1Y2;
        ...
        /*for (int i = 0; i < arWall.length; i++) {
            if (isHitS(arWall[i], sprMhead1)) {
                aniMouse2.outOfBounds();
            }
            if (isHitS(arWall[i], sprMhead2)) {
                aniMouse1.outOfBounds();
            }
        }
        for (int i = 0; i < arObstacle.length; i++) {
            if (isHitS(arObstacle[i], sprMhead1)) {
                aniMouse2.outOfBounds();
            }
            if (isHitS(arObstacle[i], sprMhead2)) {
                aniMouse1.outOfBounds();
            }
        }*/
        //pellet stuff
        ...
        batch.draw(txHamBar, nHam1X3, nHam1Y3, 20, 20);
        ...
        batch.draw(txHamBar, nHam2X3, nHam2Y3, 20, 20);
